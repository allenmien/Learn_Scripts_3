# -*-coding:utf-8-*-
"""
@Time   : 2019-03-04 17:07
@Author : Mark
@File   : predicting_movie_reviews_with_bert.py
"""
...
OUTPUT_DIR = './output'
MODEL_PATH = './bert_model/cased_L-12_H-768_A-12'
init_checkpoint = './bert_model/cased_L-12_H-768_A-12/bert_model.ckpt'
...
#         bert_module = hub.Module(spec=MODEL_PATH)
...
tokenizer = bert.tokenization.FullTokenizer(vocab_file=MODEL_PATH + '/vocab.txt', do_lower_case=True)
...
def create_model(is_predicting, input_ids, input_mask, segment_ids, labels,
    ...
    model = modeling.BertModel(
        config=modeling.BertConfig.from_json_file(MODEL_PATH + '/bert_config.json'),
        is_training=True,
        input_ids=input_ids,
        input_mask=input_mask,
